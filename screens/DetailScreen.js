...
const styles = StyleSheet.create({
  ...
  memoryBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, backgroundColor: 'rgba(99,102,241,0.08)' },
  memoryText: { fontSize: 14, color: '#4f46e5' },
  scroll: { flex: 1 },
  scrollContent: { paddingBottom: 40 },
  agentMini: { flexDirection: 'row', alignItems: 'center', gap: 6, marginHorizontal: 16, marginBottom: 12, padding: 8, paddingHorizontal: 12, borderRadius: 10, backgroundColor: 'rgba(99,102,241,0.05)', borderWidth: 1, borderColor: 'rgba(99,102,241,0.08)' },
  miniDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#6366f1' },
  miniText: { fontSize: 11, color: '#4f46e5' },
  pendingAction: {
  ...
  pendingAccent: { position: 'absolute', top: 0, left: 0, right: 0, height: 2, backgroundColor: '#6366f1' },
  pendingDisabled: { opacity: 0.5 },
  pendingNumber: { fontSize: 36, fontWeight: '700', color: '#6366f1', marginBottom: 4 },
  pendingLabel: { fontSize: 14, color: '#6b7280', fontWeight: '500' },
  pendingHint: { fontSize: 12, color: '#9ca3af', marginTop: 6 },
  ...
  infoSection: {
    marginHorizontal: 16, marginBottom: 12, padding: 16, borderRadius: 10,
    backgroundColor: '#fff', borderWidth: 1, borderColor: 'rgba(0,0,0,0.06)',
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 4, elevation: 1,
  },
  infoTitle: { fontSize: 13, fontWeight: '600', color: '#1a1a2e', marginBottom: 12 },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 6 },
  infoLabel: { fontSize: 13, color: '#6b7280' },
  infoValue: { fontSize: 13, fontWeight: '500', color: '#1a1a2e' },
  infoDesc: { fontSize: 13, color: '#6b7280', lineHeight: 20, marginTop: 10 },
  prefItem: { paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.06)' },
  prefText: { fontSize: 13, color: '#6b7280', lineHeight: 20, marginBottom: 6 },
  hashtag: { backgroundColor: 'rgba(99,102,241,0.08)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4, alignSelf: 'flex-start' },
  hashtagText: { fontSize: 11, fontWeight: '500', color: '#4f46e5' },
});
