...
const styles = StyleSheet.create({
  ...
  scrollContent: { gap: 28, paddingHorizontal: 16, paddingTop: 16, paddingBottom: 40, flexGrow: 1 },
  ...
  aiReasonText: { flex: 1, fontSize: 13, color: '#7B838D', letterSpacing: 0.5, lineHeight: 18 },
  ...
  resumeActionBtn: { backgroundColor: '#E1EFFF', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 4 },
  resumeActionBtnT: { fontSize: 14, fontWeight: '500', color: '#487FEF', lineHeight: 21 },
